...
from src.trainers.bias_evaluation_trainer import BiasEvaluationTrainer


class BiasExperimentStandardSplit(BiasEvaluationTrainer):
    def __init__(
        self,
    ...
    def experiment_name(self) -> str:
        experiment_name = "bias_experiment_standard_split"
        if self.add_info is not None:
            return f"{experiment_name}_{self.add_info}"
        else:
